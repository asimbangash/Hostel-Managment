    ...
    <div className="w-full flex align-middle justify-around items-center py-3 dark:bg-slate-800 dark:text-white">
      ...
      {showDropdown && (
        <div className="absolute bg-white shadow-md border top-14 right-32">
          <ul>
            <li className="p-1.5 cursor-pointer" onClick={closeDropdown}>
              {localStorage.getItem("email")}
            </li>
            <li className="border p-2 px-3">
              <Link to="/AdminDashboard/profile" onClick={closeDropdown}>
                My Profile
              </Link>
            </li>
            {/* <li className="border p-2 px-3">
              <Link to="/AdminDashboard/setting" onClick={closeDropdown}>
                Setting
              </Link>
            </li> */}
            <li className="border p-2 px-3">
