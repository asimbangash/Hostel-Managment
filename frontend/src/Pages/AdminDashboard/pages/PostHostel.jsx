...
const AdminPostHostel = () => {
  ...
  const renderPageContent = () => {
    switch (currentPage) {
      case 1:
        return (
          <form className="max-w-screen-lg border-2 mt-10 mb-20 ml-24 border-gray-50 shadow-inner">
            ...
            <div className="flex justify-between mx-32 mt-10 font-serif mb-20 text-[#2991DC]">
              {/* <button disabled onClick={goToPreviousPage} className="bg-[#2991DC] text-white ml-9 rounded-lg py-2 px-6 h-12 w-48 ">
                Previous
              </button> */}
              <button type="button" onClick={goToNextPageOrSubmit}   className="bg-[#2991DC] text-white ml-96 rounded-lg py-2 px-6 h-12 w-48 mr-0">
      ...
      case 2:
        return (
          <div className="max-w-screen-lg border-2 mt-10 mb-20 ml-16  border-gray-50 shadow-inner">
            ...
            <br />
            <div className="flex justify-between mx-10 mt-10 font-serif mb-10 text-[#2991DC]">
              <button onClick={goToPreviousPage} className="bg-[#2991DC] text-white  rounded-lg py-2 px-6 h-12 w-48">
              <FontAwesomeIcon icon={faCircleLeft} beat style={{ color: "#ffffff" }} /> Back</button>
              <button type="button" onClick={goToNextPageOrSubmit} className="bg-[#2991DC] text-white  rounded-lg py-2 px-6 h-12 w-48 mr-2">
              <FontAwesomeIcon icon={faCircleRight} beat style={{ color: "#ffffff" }} /> Next
              </button>
            </div>
          </div>
      ...
      case 3:
        return (
          <div className="max-w-screen-lg border-2 mt-10 mb-20 ml-24 border-gray-50 shadow-inner">
            <div className="flex flex-col justify-center items-center">
            ...
            <div className="flex justify-between mx-10 mt-10 font-serif mb-20">
              <button onClick={goToPreviousPage} 
              className="bg-[#2991DC] text-white mx-48 ml-52 h-12 w-48  rounded-lg py-2 px-6">
              
              <FontAwesomeIcon icon={faCircleLeft} beat style={{ color: "#ffffff" }} /> Back
              </button>
              <button
                onClick={goToNextPageOrSubmit}
            className="bg-[#2991DC] text-white rounded-lg py-2 px-6 h-12 w-48  mr-1"
              >
